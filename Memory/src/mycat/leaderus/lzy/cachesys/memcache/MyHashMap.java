...
public class MyHashMap<K,V> extends AbstractMap<K,V>
    ...
    final void putMapEntries(Map<? extends K, ? extends V> m, boolean evict) {
        ...
        if (s > 0) {
            ...
            for (Map.Entry<? extends K, ? extends V> e : m.entrySet()) {
                K key = e.getKey();
                V value = e.getValue();
                putVal(key.hashCode(), key, value, false, evict);
            }
        }
    }
    ...
    public V get(Object key) {
        Node<K,V> e;
        return (e = getNode(key.hashCode(), key)) == null ? null : e.value;
    }
    ...
    public boolean containsKey(Object key) {
        return getNode(key.hashCode(), key) != null;
    }
    ...
    public V put(K key, V value) {
        return putVal(key.hashCode(), key, value, false, true);
    }
    ...
    public V remove(Object key) {
        Node<K,V> e;
        return (e = removeNode(key.hashCode(), key, null, false, true)) == null ?
                null : e.value;
    }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public final boolean remove(Object key) {
            return removeNode(key.hashCode(), key, null, false, true) != null;
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public final boolean contains(Object o) {
            ...
            Map.Entry<?,?> e = (Map.Entry<?,?>) o;
            Object key = e.getKey();
            Node<K,V> candidate = getNode(key.hashCode(), key);
        ...
        public final boolean remove(Object o) {
            if (o instanceof Map.Entry) {
                ...
                return removeNode(key.hashCode(), key, value, true, true) != null;
            }
            return false;
        }
    ...
    public V getOrDefault(Object key, V defaultValue) {
        Node<K,V> e;
        return (e = getNode(key.hashCode(), key)) == null ? defaultValue : e.value;
    }

    @Override
    public V putIfAbsent(K key, V value) {
        return putVal(key.hashCode(), key, value, true, true);
    }
    ...
    public boolean replace(K key, V oldValue, V newValue) {
        Node<K,V> e; V v;
        if ((e = getNode(key.hashCode(), key)) != null &&
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        if (mappings < 0)
            ...
            for (int i = 0; i < mappings; i++) {
                ...
                putVal(key.hashCode(), key, value, false, false);
            }
        }
    }
    ...
    abstract class HashIterator {
        ...
        public final void remove() {
            ...
            current = null;
            K key = p.key;
            removeNode(key.hashCode(), key, null, false, false);
            expectedModCount = modCount;
        }
    }
